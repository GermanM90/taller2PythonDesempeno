...
import random # Se utiliza para seleccionar aleatoriamente un lugar de estacionamiento disponible.
import math #Se importa para realizar cálculos matemáticos.
...
# Se crean listas de diccionarios llamadas name_camp_cars y name_camp_moto que almacenan la información de los campos, incluyendo si están disponibles.
